...
you should place your code here."
  ...
  (global-set-key (kbd "S-<f10>")
                  (lambda ()
                    (interactive)
                    (dired "/Users/shiyuanguo/Dropbox/org_files/future")))
  (global-set-key (kbd "S-<f12>")
                  (lambda ()
                    (interactive)
                    (find-file "~/Library/Mobile Documents/com~apple~CloudDocs/rotation/GirkeLab/notes.org")))
  (global-set-key (kbd "S-<f11>")
                  (lambda ()
                    (interactive)
                    (find-file "/Users/shiyuanguo/Dropbox/org_files/tech.org")))
  (global-set-key (kbd "S-<f9>")
                  (lambda ()
                    (interactive)
                    (dired "/Users/shiyuanguo/Library/Mobile Documents/com~apple~CloudDocs/integratedLearning")))
  (global-set-key (kbd "S-<f8>")
                  (lambda ()
                    (interactive)
                    (dired "/Users/shiyuanguo/Dropbox/org_files/testing_ground")))
  (global-set-key (kbd "S-<f7>")
                  (lambda ()
                    (interactive)
                    (find-file "/Users/shiyuanguo/.spacemacs")))
